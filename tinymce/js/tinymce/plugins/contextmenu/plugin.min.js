...
const g=a.DOM; return c.add('contextmenu', function(a) {
let c, h, i=a.settings.contextmenu_never_use_native, j=function(a) {
return a.ctrlKey&&!i;
}, k=function() {
...
const i=[]; e.each(f.split(/[ ,]/), function(b) {
let c=a.menuItems[b]; '|'==b&&(c={ text: b }), c&&(c.shortcut='', i.push(c));
}); for (let k=0; k<i.length; k++)'|'==i[k].text&&(0!==k&&k!=i.length-1||i.splice(k, 1)); c=new d({ items: i, context: 'contextmenu', classes: 'contextmenu' }).renderTo(), c.on('hide', function(a) {
a.control===this&&(h=!1);
}), a.on('remove', function() {
c.remove(), c=null;
});
} let l={ x: b.pageX, y: b.pageY }; a.inline||(l=g.getPos(a.getContentAreaContainer()), l.x+=b.clientX, l.y+=b.clientY), c.moveTo(l.x, l.y), h=!0;
}
