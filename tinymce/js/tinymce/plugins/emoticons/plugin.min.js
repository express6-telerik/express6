...
function d() {
let a; return a='<table role="list" class="mce-grid">', b.each(e, function(d) {
a+='<tr>', b.each(d, function(b) {
const d=c+'/img/smiley-'+b+'.gif'; a+='<td><a href="#" data-mce-url="'+d+'" data-mce-alt="'+b+'" tabindex="-1" role="option" aria-label="'+b+'"><img src="'+d+'" style="width: 18px; height: 18px" role="presentation" /></a></td>';
}), a+='</tr>';
}), a+='</table>';
} var e=[['cool', 'cry', 'embarassed', 'foot-in-mouth'], ['frown', 'innocent', 'kiss', 'laughing'], ['money-mouth', 'sealed', 'smile', 'surprised'], ['tongue-out', 'undecided', 'wink', 'yell']]; a.addButton('emoticons', { type: 'panelbutton', panel: { role: 'application', autohide: !0, html: d, onclick: function(b) {
const c=a.dom.getParent(b.target, 'a'); c&&(a.insertContent('<img src="'+c.getAttribute('data-mce-url')+'" alt="'+c.getAttribute('data-mce-alt')+'" />'), this.hide());
} }, tooltip: 'Emoticons' });
}), function() {};
}), d('0')();
}());
